...
public class Driver {
	 ...
	 * @param s			RegistrationSystem
	 * @param list		keyword to print specific list
	 */
	private static void printList(RegistrationSystem s, String list){
		...
		if(list.equals("student")) {
			...
			System.out.println("Course/Prerequisites List");
	...
	private static void populateSections(RegistrationSystem system) throws CourseNotFoundException, PersonNotFoundException, DuplicateCourseException, SectionNotFoundException {
